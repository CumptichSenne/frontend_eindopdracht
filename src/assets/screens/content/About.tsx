 ...
 return (
   <div className="h-full bg-slate-800">
    ...
    <div className="flex flex-col align-middle justify-center text-center">
        ...
        <article className="flex flex-col items-center align-middle justify-center md:flex-row-reverse md:items-center mt-[10vh] m-4">
            <div className="flex flex-col items-center max-w-lg md:basis-3/5 bg-slate-700 md:mr-8 rounded-lg drop-shadow-2xl">
                <h1 className="text-3xl text-center text-slate-200 max-w-[32rem] font-bold">Hobbies</h1>
                <p className="text-slate-200 max-w-[32rem] leading-relaxed md:text-lg text-left">
